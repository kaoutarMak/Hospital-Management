...
import com.Hospital_Management.DAO.UserRepository;
...
public class UserServiceImpl implements UserService {
	...
	/*
	 * @Override public boolean updatePassword(ChangePasswordModel
	 * changePasswordModel) { User user =
	 * this.userRepository.findById(changePasswordModel.getUserId()).get(); String
	 * encryptedPassword =
	 * this.bCryptPasswordEncoder.encode(changePasswordModel.getPassword()); if
	 * (!this.bCryptPasswordEncoder.matches(changePasswordModel.getOldPassword(),
