...
import com.Hospital_Management.DAO.WeekScheduleRepository;
...
import com.Hospital_Management.entities.DayOfWeek;
...
public class WeekScheduleServiceImpl implements WeekScheduleService {
    ...
    public EditWeekScheduleModel getById(long id) {
        WeekSchedule weekSchedule = this.weekScheduleRepository.findById(id).get();
